...
Over the next five years, I expect governments and regulating bodies to play a larger role in regulating AI. The European Union’s AI Act is an early example of this trend. Whether AI’s progress mirrors past technologies will depend not just on innovation, but on how societies decide to govern it. If regulation is implemendted effeciently, AI can be a powerful enabler; if not, risks like misinformation and surveillance could dominate.
